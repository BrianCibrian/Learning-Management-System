...
public class ViewRole2Home {
	...
	// Omar HW2: added button for view post
	...
	private ViewRole2Home() {
        ...
        setupButtonUI(button_FeedbackSystem, "Dialog", 16, 250, Pos.CENTER, 20, 320);
        button_FeedbackSystem.setOnAction((event) -> {
            ControllerRole2Home.openFeedbackSystem();
        });
        ...
        // HW2 Omar: added view post button
        theRootPane.getChildren().addAll(
			label_PageTitle, label_UserDetails, button_UpdateThisUser, line_Separator1,
	        line_Separator4, button_Logout, button_Quit, button_ViewPosts, button_FeedbackSystem);
	}
