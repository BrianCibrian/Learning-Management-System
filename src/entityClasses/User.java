...
public class User {
    ...
    /*****
     * <p> Description: getFullName() combines the first and last name of the user. getRolesAsString() converts the role
     * into a String that is returned to be displayed in the table. </p>
     *
     * @return String fullName
     * 
     * @return String roleAsString
     * 
    ...
    if (adminRole) roles.append("Admin, ");
    if (role1) roles.append("Staff, ");
    if (role2) roles.append("Student, ");
    
    //Added to separate the roles by space and comma, 
    //once reached the last role it removes the trailing comma and space
    if (roles.length() > 0) {
