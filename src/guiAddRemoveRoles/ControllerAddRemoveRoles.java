...
public class ControllerAddRemoveRoles {
	...
	protected static void performAddRole() {
		...
		if (ViewAddRemoveRoles.theAddRole.compareTo("<Select a role>") != 0) {
			String roleKey = ViewAddRemoveRoles.theAddRole;
			if ("Staff".equals(ViewAddRemoveRoles.theAddRole)) roleKey = "Role1";
			if ("Student".equals(ViewAddRemoveRoles.theAddRole)) roleKey = "Role2";
	...
	protected static void performRemoveRole() {
		...
		if (ViewAddRemoveRoles.theRemoveRole.compareTo("<Select a role>") != 0) {
			String roleKey = ViewAddRemoveRoles.theRemoveRole;
			if ("Staff".equals(ViewAddRemoveRoles.theRemoveRole)) roleKey = "Role1";
			if ("Student".equals(ViewAddRemoveRoles.theRemoveRole)) roleKey = "Role2";
